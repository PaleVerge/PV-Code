...
private:
    ...
    int single_sal;
public:
    BWorker(string _name,int _num,int _single_sal)
    :Worker(_name),num(_num),single_sal(_single_sal){}
    void printInfo(){
...
class CWorker:public Worker{
    private:
        ...
        int bonus;
public:
    CWorker(string _name,int _salary,int _bonus)
        :Worker(_name),salary(_salary),bonus(_bonus){}
